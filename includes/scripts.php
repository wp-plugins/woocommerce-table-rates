...
function wpr_table_rate_admin_scripts( $hook ) {
    ...
    if ($hook == 'woocommerce_page_wc-settings') {
        ...
        wp_enqueue_script( 'wpr_table_rate_admin_js', WPTR_SHIPPING_URL . 'assets/js/admin' . $suffix . '.js', array( 'jquery' ) );
        wp_enqueue_style( 'wpr_table_rate_admin_css', WPTR_SHIPPING_URL . 'assets/css/admin' . $suffix . '.css' );
    }
}
...
function wpr_table_rate_scripts( $hook ) {
    ...
    wp_enqueue_script( 'wpr_table_ratejs', WPTR_SHIPPING_URL . 'assets/js/scripts' . $suffix . '.js', array( 'jquery' ) );
    wp_enqueue_style( 'wpr_table_ratecss', WPTR_SHIPPING_URL . 'assets/css/styles' . $suffix . '.css' );
}
